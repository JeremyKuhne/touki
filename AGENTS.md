...
- [.github/instructions/tests.instructions.md](.github/instructions/tests.instructions.md) - conventions for `test/touki.tests/**/*.cs`.
- [.github/instructions/perf.instructions.md](.github/instructions/perf.instructions.md) - BenchmarkDotNet conventions and the JIT-naming rule for `test/touki.perf/**/*.cs`.
