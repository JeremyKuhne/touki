...
internal static class ValueJitWarmup
{
    ...
    public static void Ensure()
    {
        ...
        Value.Create(value: (bool)default).As<bool>();
        Value.Create(value: (byte)default).As<byte>();
        Value.Create(value: (sbyte)default).As<sbyte>();
        Value.Create(value: (char)default).As<char>();
        Value.Create(value: (double)default).As<double>();
        Value.Create(value: (short)default).As<short>();
        Value.Create(value: (int)default).As<int>();
        Value.Create(value: (long)default).As<long>();
        Value.Create(value: (ushort)default).As<ushort>();
        Value.Create(value: (uint)default).As<uint>();
        Value.Create(value: (ulong)default).As<ulong>();
        Value.Create(value: (float)default).As<float>();
        Value.Create(value: (double)default).As<double>();
        Value.Create(value: (DateTime)default).As<DateTime>();
        Value.Create(value: (DateTimeOffset)default).As<DateTimeOffset>();
        Value.Create(value: default(StringSegment)).As<StringSegment>();
