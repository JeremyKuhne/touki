...
internal static class GeneratorTestHarness
{
        ...
        string source)
    {
        return CSharpCompilation.Create(
            assemblyName: "Touki.Resources.Generator.TestCompilation",
    ...
    private static ImmutableArray<MetadataReference> GetReferences()
    {
        ...
        string toukiAssembly = typeof(StringResourceManager).Assembly.Location;
        if (paths.Add(toukiAssembly))
        {
            references.Add(MetadataReference.CreateFromFile(toukiAssembly));
        }
...
internal sealed class GeneratedAssembly : IDisposable
{
    ...
    public void Dispose()
    {
        _loadContext.Resolving -= ResolveTouki;
        _loadContext.Unload();
    }

    private static Assembly? ResolveTouki(AssemblyLoadContext context, AssemblyName name)
    {
        Assembly toukiAssembly = typeof(StringResourceManager).Assembly;
        return name.Name == toukiAssembly.GetName().Name ? toukiAssembly : null;
    }
}
...
internal sealed class GeneratorTestResource
{
        ...
        IReadOnlyDictionary<string, string>? metadata = null)
    {
        Dictionary<string, string> values = new(StringComparer.Ordinal)
        {
            ...
            ["ToukiResourceFamily"] = "Test.Resources.Strings",
        ...
        string resourceFamily = "Test.Resources.Strings")
    {
        Dictionary<string, string> metadata = new(StringComparer.Ordinal)
        {
            ...
            ["ToukiResourceFamily"] = resourceFamily
        };
