...
public sealed class MSBuildEnumerator : FileSystemEnumerator<string>
{
        ...
        : base(startDirectory, options ?? s_defaultOptions)
    {
        ...
        _spec = new Spec(fullPathSpec, startDirectory, _matchType, _matchCasing);
    }
    ...
    private class Spec
    {
        ...
        public Spec(string fullPathSpec, string startDirectory, MatchType matchType, MatchCasing matchCasing)
        {
