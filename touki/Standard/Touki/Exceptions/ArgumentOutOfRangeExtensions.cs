...
public static class ArgumentOutOfRangeExtensions
{
    ...
    private static void ThrowZero<T>(T value, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            string.FormatValues(SRS.ArgumentOutOfRange_Generic_MustBeNonZero, Value.Create(paramName), Value.Create(value)));
    ...
    private static void ThrowNegative<T>(T value, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            string.FormatValues(SRS.ArgumentOutOfRange_Generic_MustBeNonNegative, Value.Create(paramName), Value.Create(value)));
    ...
    private static void ThrowNegativeOrZero<T>(T value, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            string.FormatValues(SRS.ArgumentOutOfRange_Generic_MustBeNonNegativeNonZero, Value.Create(paramName), Value.Create(value)));
    ...
    private static void ThrowGreater<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            string.FormatValues(SRS.ArgumentOutOfRange_Generic_MustBeLessOrEqual, Value.Create(paramName), Value.Create(value), Value.Create(other)));
    ...
    private static void ThrowGreaterEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            string.FormatValues(SRS.ArgumentOutOfRange_Generic_MustBeLess, Value.Create(paramName), Value.Create(value), Value.Create(other)));
    ...
    private static void ThrowLess<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            string.FormatValues(SRS.ArgumentOutOfRange_Generic_MustBeGreaterOrEqual, Value.Create(paramName), Value.Create(value), Value.Create(other)));
    ...
    private static void ThrowLessEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            string.FormatValues(SRS.ArgumentOutOfRange_Generic_MustBeGreater, Value.Create(paramName), Value.Create(value), Value.Create(other)));
    ...
    private static void ThrowEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            ...
            value,
            string.FormatValues(
                SRS.ArgumentOutOfRange_Generic_MustBeNotEqual,
    ...
    private static void ThrowNotEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            ...
            value,
            string.FormatValues(
                SRS.ArgumentOutOfRange_Generic_MustBeEqual,
                Value.Create(paramName),
                Value.Create((object?)value ?? "null"),
                Value.Create((object?)other ?? "null")));
