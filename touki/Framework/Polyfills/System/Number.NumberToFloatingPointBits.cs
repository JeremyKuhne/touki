...
internal unsafe partial class Number
{
    public readonly struct FloatingPointInfo
    {
        ...
        public static readonly FloatingPointInfo s_single = new(
    ...
    {
        Debug.Assert(count is >= 1 and <= 19);
        ...
        uint fractionalDigitsPresent)
    {
        ...
        AccumulateDecimalDigitsIntoBigInteger(ref number, fractionalFirstIndex, fractionalLastIndex, out scoped BigInteger fractionalNumerator);
