...
public class BitOperationsTests
{
    ...
    [DataRow(9, false)]
    [DataRow(15, false)]
    [DataRow(int.MaxValue, false)] // 2^31-1
    [DataRow(int.MinValue, false)] // -2^31
    ...
    [DataRow(9u, false)]
    [DataRow(15u, false)]
    [DataRow(uint.MaxValue, false)] // 2^32-1
    ...
    [DataRow(9L, false)]
    [DataRow(15L, false)]
    [DataRow(long.MaxValue, false)] // 2^63-1
    [DataRow(long.MinValue, false)] // -2^63
    ...
    [DataRow(9UL, false)]
    [DataRow(15UL, false)]
    [DataRow(ulong.MaxValue, false)] // 2^64-1
    ...
    [DataRow(1023u, 1024u)]
    [DataRow(1025u, 2048u)]
    [DataRow(0x80000001u, 0u)] // Overflow case
    [DataRow(uint.MaxValue, 0u)] // Overflow case
    ...
    [DataRow(9UL, 16UL)]
    [DataRow(15UL, 16UL)]
    [DataRow(1023UL, 1024UL)]
    [DataRow(1025UL, 2048UL)]
    [DataRow(0x8000000000000001UL, 0UL)] // Overflow case
    [DataRow(ulong.MaxValue, 0UL)] // Overflow case
    ...
    [DataRow(7u, 29)]
    [DataRow(9u, 28)]
    [DataRow(0x0FFFFFFFu, 4)]
    [DataRow(0xFFFFFFFFu, 0)]
    ...
    [DataRow(7UL, 61)]
    [DataRow(9UL, 60)]
    [DataRow(0x0FFFFFFFFFFFFFFFUL, 4)]
    [DataRow(0xFFFFFFFFFFFFFFFFUL, 0)]
    ...
    [DataRow(9u, 2)]
    [DataRow(15u, 4)]
    [DataRow(0x0FFFFFFFu, 28)]
    [DataRow(0xFFFFFFFFu, 32)]
    ...
    [DataRow(9UL, 2)]
    [DataRow(15UL, 4)]
    [DataRow(0x0FFFFFFFFFFFFFFFUL, 60)]
    [DataRow(0xFFFFFFFFFFFFFFFFUL, 64)]
